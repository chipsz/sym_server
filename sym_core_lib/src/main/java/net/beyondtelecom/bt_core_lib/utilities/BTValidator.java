...
public class BTValidator
{
    ...
    public static final String MSISDN_REGEX = "^(([0]{2})|[+])*(" + getBundle("properties/gopay", ENGLISH).getString("CountryCode") + ")[0-9]{9}";
    public static final String FULL_MSISDN_REGEX = "^(" + getBundle("properties/gopay", ENGLISH).getString("CountryCode") + ")[0-9]{9}";
