...
import static net.beyondtelecom.bt_core_lib.utilities.CommonUtilities.*;
import static net.beyondtelecom.bt_core_lib.utilities.IOUtils.getOSDefaultTempDir;
...
public class CommonUtilitiesTest {
    ...
    @Test
    public void testGetValueByStringPattern() throws Exception {
        System.out.println("RUNNING TEST: getValueByStringPattern");
        String inputString = "77384296047778,100017220219,100,1,20171231,BeyondTelecoms,,,";
        String inputPattern = "(\\d+),(\\d+),(\\d+),(.*)";
        BTResponseObject<String> response = getValueByStringPattern(inputString,inputPattern,3);
