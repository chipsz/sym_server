...
public class AuthGroupConverter implements Converter {
    ...
    public Object getAsObject(FacesContext context, UIComponent component, String value) {
        if (isNumeric(value)) {
            return getEntityManagerRepo().findById(sym_auth_group.class, parseLong(value));
        } else {
            return findByName(sym_auth_group.class, value);
        }
    }
    ...
    public String getAsString(FacesContext context, UIComponent component, Object value) {
        if (value instanceof Long) {
            return getEntityManagerRepo().findById(sym_auth_group.class, parseLong(value.toString())).getName();
        } else if (value instanceof sym_auth_group) {
            return ((sym_auth_group) value).getName();
        } else return null;
    }
}