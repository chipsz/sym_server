...
import static net.beyondtelecom.web_ui.validation.ConstraintHelper.changeAnnotationValue;
...
public class EmailValidator implements Validator, ClientValidator {
    ...
    public static final String EMAIL_VALIDATION_ERROR = "Invalid email: Must be in the form xxx@yyy.com";
    ...
    public String getValidatorId() { return "custom.emailValidator"; }
