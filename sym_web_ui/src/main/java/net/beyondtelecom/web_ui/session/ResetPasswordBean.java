...
import static net.beyondtelecom.web_ui.common.SystemPages.PAGE_RESET_PASSWORD;
...
public class ResetPasswordBean implements Serializable {
    ...
    @Autowired
    public ResetPasswordBean(SessionBean sessionBean) { this.sessionBean = sessionBean; }
    ...
    public String resetPassword() {
        ...
        List<bt_auth_user> results = getEntityManagerRepo().findWhere(bt_auth_user.class, new ArrayList<> (asList(
            new Pair<>("channel", findByName(bt_channel.class, WEB.name()).getId()),
        ...
        bt_auth_user resetUser = results.get(0);
        ...
        bt_request_response_log log = new bt_request_response_log(
        ...
        BTResponseObject<bt_auth_user> result = authProvider.changePassword(resetUser, Gen(), false, null);
