...
public abstract class JSFReportable extends JSFExportable implements Serializable {
    ...
    @PostConstruct public void init() { initializeReportTimes(); }
    ...
    public Date getReportStartDate() { return reportStartDate; }

    public void setReportStartDate(Date reportStartDate) { this.reportStartDate = reportStartDate; }

    public Date getReportEndDate() { return reportEndDate; }

    public void setReportEndDate(Date reportEndDate) { this.reportEndDate = reportEndDate; }
}
