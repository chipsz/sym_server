...
public class SystemPage {
    ...
    public String getBaseXHTML() { return baseXHTML; }

    public void setBaseXHTML(String baseXHTML) { this.baseXHTML = baseXHTML; }

    public String getIncludeXHTML() { return includeXHTML; }

    public void setIncludeXHTML(String includeXHTML) { this.includeXHTML = includeXHTML; }
