...
public class TargetPrincipal  implements java.io.Serializable {
    private PrincipalId principalId;

    public TargetPrincipal() {
    }
    ...
    /**
     * Gets the principalId value for this TargetPrincipal.
     * 
     * @return principalId
     */
    ...
    /**
     * Sets the principalId value for this TargetPrincipal.
     * 
     * @param principalId
     */
    ...
    public synchronized boolean equals(Object obj) {
        if (!(obj instanceof TargetPrincipal)) return false;
        TargetPrincipal other = (TargetPrincipal) obj;
    ...
    private static org.apache.axis.description.TypeDesc typeDesc =
        new org.apache.axis.description.TypeDesc(TargetPrincipal.class, true);

    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://external.interfaces.ers.seamless.com/", "targetPrincipal"));
