...
public class ERSWSPurchaseResponse  extends ERSWSResponse  implements java.io.Serializable {
    ...
    private net.symbiosis.core.integration.voucher.glo.seamless.PurchaseOrderResultRow[] purchasedProducts;
    ...
    public ERSWSPurchaseResponse(
           ...
           net.symbiosis.core.integration.voucher.glo.seamless.PurchaseOrderResultRow[] purchasedProducts) {
        super(
            ersReference,
            resultCode,
            resultDescription);
     ...
     */
    public void setPaymentPrincipal(Principal paymentPrincipal) {
        this.paymentPrincipal = paymentPrincipal;
    }
     ...
     */
    public net.symbiosis.core.integration.voucher.glo.seamless.PurchaseOrderResultRow[] getPurchasedProducts() {
        return purchasedProducts;
    }
     ...
     */
    public void setPurchasedProducts(net.symbiosis.core.integration.voucher.glo.seamless.PurchaseOrderResultRow[] purchasedProducts) {
        this.purchasedProducts = purchasedProducts;
    }

    public net.symbiosis.core.integration.voucher.glo.seamless.PurchaseOrderResultRow getPurchasedProducts(int i) {
        return this.purchasedProducts[i];
    }

    public void setPurchasedProducts(int i, net.symbiosis.core.integration.voucher.glo.seamless.PurchaseOrderResultRow _value) {
    ...
    public synchronized int hashCode() {
        ...
        if (getPurchasedProducts() != null) {
            for (int i=0;
                 ...
                 i++) {
                Object obj = java.lang.reflect.Array.get(getPurchasedProducts(), i);
                if (obj != null &&
    ...
    static {
        ...
        elemField.setXmlType(new javax.xml.namespace.QName("http://external.interfaces.ers.seamless.com/", "purchaseOrderResultRow"));
        elemField.setMinOccurs(0);
