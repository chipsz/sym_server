...
public class ProductDetail  implements java.io.Serializable {
    ...
    /**
     * Gets the map value for this ProductDetail.
     * 
     * @return map
     */
    public Entry[] getMap() {
    ...
    /**
     * Sets the map value for this ProductDetail.
     * 
     * @param map
     */
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://external.interfaces.ers.seamless.com/", "productDetail"));
        org.apache.axis.description.ElementDesc elemField = new org.apache.axis.description.ElementDesc();
        elemField.setFieldName("map");
        elemField.setXmlName(new javax.xml.namespace.QName("", "map"));
        elemField.setXmlType(new javax.xml.namespace.QName("http://external.interfaces.ers.seamless.com/", "entry"));
