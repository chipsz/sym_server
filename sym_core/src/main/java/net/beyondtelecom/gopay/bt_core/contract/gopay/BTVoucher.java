 ...
 ***************************************************************************/
@XmlRootElement
public class BTVoucher implements Serializable {
	...
	public Double getDefaultMerchantDiscount() { return defaultMerchantDiscount; }

	public void setDefaultMerchantDiscount(Double defaultMerchantDiscount) { this.defaultMerchantDiscount = defaultMerchantDiscount; }
	...
	public void setIsFixed(Boolean fixed) { isFixed = fixed; }

	public Boolean getIsPinBased() { return isPinBased; }

	public void setIsPinBased(Boolean pinBased) { isPinBased = pinBased; }
}
