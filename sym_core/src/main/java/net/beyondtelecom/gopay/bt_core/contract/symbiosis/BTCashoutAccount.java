...
@XmlRootElement
public class BTCashoutAccount implements Serializable {
    ...
    public BTCashoutAccount(){}

    public BTCashoutAccount(Long cashoutAccountId, Long institutionId, String accountNickName, String accountName,
    ...
    public Long getCashoutAccountId() { return cashoutAccountId; }

    public void setCashoutAccountId(Long cashoutAccountId) { this.cashoutAccountId = cashoutAccountId; }
    ...
    public String getAccountBranchCode() { return accountBranchCode; }

    public void setAccountBranchCode(String accountBranchCode) { this.accountBranchCode = accountBranchCode; }
