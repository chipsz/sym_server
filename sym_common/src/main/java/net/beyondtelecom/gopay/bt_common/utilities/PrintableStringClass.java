    ...
    default String toPrintableString() {
        ...
        try {
            ...
            for (Field field : this.getClass().getDeclaredFields()) {
                ...
                else if (fieldValue instanceof Number)  { fieldData = "" + fieldValue; }
                else if (fieldValue instanceof Boolean)  { fieldData = "" + ((Boolean) fieldValue).booleanValue(); }
                else									{ fieldData = "[" + field.getName() + ":" +/* fieldValue +*/ "not null]"; }
