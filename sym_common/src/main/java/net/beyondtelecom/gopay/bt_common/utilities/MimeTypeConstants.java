...
final class MimeTypeConstants
{
    ...
    static {
        ...
        MIME_TYPES.put("gpg", "application/pgp");
        ...
        MIME_TYPES.put("pgp", "application/pgp");
    ...
    static String getMimeTypeByFileName(String filename) {
        ...
        if (dotPos == -1 || filename.length() - dotPos + 1 <= 0) { return null; }
        return MIME_TYPES.get(filename.substring(dotPos + 1));
    }
}