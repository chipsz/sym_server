...
public class MutexLock {
    ...
    private Long waitTimeout = Long.parseLong(Configuration.getBeyondTelecomProperty("MutexLockWaitTime"));

    private Long waitInterval = Long.parseLong(Configuration.getBeyondTelecomProperty("MutexLockInterval"));
