...
import static net.beyondtelecom.gopay.bt_common.utilities.Format.DATE_FORMAT;
...
public class SymTransformer {
	...
	public static String dateToString(Date date) { return DATE_FORMAT.format(date); }
