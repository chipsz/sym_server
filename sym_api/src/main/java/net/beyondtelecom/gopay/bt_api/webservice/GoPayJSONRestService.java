...
@Component
@Path("/server/json/goPay")
@Consumes({MediaType.APPLICATION_JSON, MediaType.APPLICATION_FORM_URLENCODED, MediaType.MULTIPART_FORM_DATA})
@Produces("application/json; charset=UTF-8")
@JsonInclude(JsonInclude.Include.NON_NULL)
public class GoPayJSONRestService extends GoPayXMLRestService {

    @Autowired
    public GoPayJSONRestService(GoPayRequestProcessor goPayRequestProcessor) { super(goPayRequestProcessor); }
