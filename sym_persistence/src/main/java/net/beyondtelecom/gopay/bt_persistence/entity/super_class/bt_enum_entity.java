 ...
 */
@MappedSuperclass
public abstract class bt_enum_entity<E extends bt_enum_entity> extends bt_entity<E> {
    ...
    public bt_enum_entity() {}

    public bt_enum_entity (String name, Boolean is_enabled) {
        this.name = name;
    ...
    public void setIs_enabled(Boolean enabled) { this.is_enabled = enabled; }
