...
@Entity
@Table(name = "bt_financial_institution")
@AttributeOverrides( {
...
public class bt_financial_institution extends bt_enum_entity<bt_financial_institution> {
	...
	private bt_financial_institution_type institution_type;
	@Basic
    @Column(unique = true)
	...
	public bt_financial_institution() {}

	public bt_financial_institution(String name, Boolean enabled, String short_name,
                                    bt_financial_institution_type institution_type, String swift_code,
    ...
    public bt_financial_institution_type getInstitution_type() { return institution_type; }

    public void setInstitution_type(bt_financial_institution_type institution_type) { this.institution_type = institution_type; }

    public String getSwift_code() { return swift_code; }

	public void setSwift_code(String swift_code) { this.swift_code = swift_code; }

	public String getPhysical_address() { return physical_address; }

	public void setPhysical_address(String physical_address) { this.physical_address = physical_address; }
	...
	public String getContact_fax() { return contact_fax; }

	public void setContact_fax(String contact_fax) { this.contact_fax = contact_fax; }
