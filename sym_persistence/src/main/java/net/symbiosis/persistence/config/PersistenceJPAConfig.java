...
@ComponentScan({ "net.symbiosis.persistence" })
@EnableJpaRepositories(basePackages = "net.symbiosis.persistence.dao")
public class PersistenceJPAConfig {
	...
	public LocalContainerEntityManagerFactoryBean entityManagerFactory() {
		...
		entityManagerFactoryBean.setPackagesToScan("net.symbiosis.persistence.entity");
