...
insert ignore into sym_voucher (is_active,is_fixed,is_pin_based,units,voucher_provider_discount,voucher_type_id,voucher_value,service_provider_id,voucher_provider_id,description) values (1, 0, 0, 'GHS', 7, 1, '1', 2, 2, 'VARIABLE AMOUNT AIRTIME');
...
insert ignore into sym_voucher (is_active,is_fixed,is_pin_based,units,voucher_provider_discount,voucher_type_id,voucher_value,service_provider_id,voucher_provider_id,description) values (1, 1, 1, 'GHS', 6.5, 1, '1.00', 3, 3, 'GHS1 AIRTIME');
insert ignore into sym_voucher (is_active,is_fixed,is_pin_based,units,voucher_provider_discount,voucher_type_id,voucher_value,service_provider_id,voucher_provider_id,description) values (1, 1, 1, 'GHS', 6.5, 1, '2.00', 3, 3, 'GHS2 AIRTIME');
insert ignore into sym_voucher (is_active,is_fixed,is_pin_based,units,voucher_provider_discount,voucher_type_id,voucher_value,service_provider_id,voucher_provider_id,description) values (1, 1, 1, 'GHS', 6.5, 1, '5.00', 3, 3, 'GHS5 AIRTIME');
insert ignore into sym_voucher (is_active,is_fixed,is_pin_based,units,voucher_provider_discount,voucher_type_id,voucher_value,service_provider_id,voucher_provider_id,description) values (1, 1, 1, 'GHS', 6.5, 1, '10.00', 3, 3, 'GHS10 AIRTIME');
insert ignore into sym_voucher (is_active,is_fixed,is_pin_based,units,voucher_provider_discount,voucher_type_id,voucher_value,service_provider_id,voucher_provider_id,description) values (1, 1, 1, 'GHS', 6.5, 1, '20.00', 3, 3, 'GHS20 AIRTIME');
...
insert ignore into sym_voucher (is_active,is_fixed,is_pin_based,units,voucher_provider_discount,voucher_type_id,voucher_value,service_provider_id,voucher_provider_id,description) values (1, 1, 1, 'GHS', 10, 4, '7.50', 7, 7, 'GHS7.50 RESULT PIN');
