...
insert ignore into sym_financial_institution (institution_name,short_name,institution_type_id) values ('People\'s Own Savings Bank','POSB',1);
...
/* Insert roles for SYM_SYSTEM_ADMIN */
...
insert ignore into sym_wallet_group (wallet_group_id,name,is_enabled,default_discount) values (1, 'DEFAULT_WALLET_GROUP', 1, 1.0);
